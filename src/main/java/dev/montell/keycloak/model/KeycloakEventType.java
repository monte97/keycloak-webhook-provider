...
public enum KeycloakEventType {
     ...
     *
     * @param eventType the prefixed event type string as stored by this provider,
     *                  e.g. "access.LOGIN" or "admin.USER-CREATE". Raw Keycloak
     *                  {@code EventType} names (e.g. "LOGIN") are NOT supported —
     *                  callers must apply the "access." / "admin." prefix first.
