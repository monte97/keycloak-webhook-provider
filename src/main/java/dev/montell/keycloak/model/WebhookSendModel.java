...
/**
 * Domain model for a webhook delivery attempt. Tracks HTTP status, success/failure,
 * retry count, and timestamps. One send record exists per webhook-event pair and is
 * updated in place on retries.
 *
