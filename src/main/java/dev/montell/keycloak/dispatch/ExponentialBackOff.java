...
/**
 * Exponential backoff with jitter. One instance per retry chain — not thread-safe. Call {@link
 * #nextBackOffMillis()} to get the next delay; returns {@link #STOP} when maxElapsedTime is
 * exceeded.
 *
...
public class ExponentialBackOff {
    ...
    /**
     * Convenience constructor using spec defaults; overrides per-webhook via
     * maxElapsed/maxInterval.
     */
    ...
    /**
     * Returns the delay for the next retry in milliseconds, or {@link #STOP} if {@code
